...
Additionally, we worked with a custom dataset, called [MELD Embeddings](https://www.kaggle.com/datasets/Totemish/meld-embeddings/data) where we generated and stored required encodings. The training set consists of **9989 examples**, categorized into **7 emotion classes**.
